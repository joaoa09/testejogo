...
while a_executar:
    ...
    if not jogo_finalizado:
        ...
        # ### MODIFICADO ### - Adicionado controle por WASD
    ...
    # --- Lógica da Vitória Final (Tocar na porta) ---
    ...
    # Lógica para exibir a mensagem de vitória temporária
    ...
    # Desenha a tela de vitória final
    if jogo_finalizado:
